...
use Illuminate\Http\Request\TipoRestauranteRequest;
...
class TipoRestauranteController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(TipoRestauranteRequest $request)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(TipoRestauranteRequest $request, TipoRestaurante $tipoRestaurante)
    {
        //
    }
